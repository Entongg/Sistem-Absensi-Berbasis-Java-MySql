...
public class TeacherDAO implements ServiceTeacher {
    ...
    @Override
    public List<Teacher> getDataInDelete() {
        List<Teacher> list = new ArrayList<>();
        PreparedStatement st = null;
        ResultSet rs = null;
        try {
    ...
    @Override
    public List<Teacher> searchDataInDelete(String keyword) {
        List<Teacher> list = new ArrayList<>();
        PreparedStatement st = null;
        ResultSet rs = null;
        try {
    ...
    @Override
    public boolean validateINIP(Teacher model) {
        PreparedStatement st = null;
        ResultSet rs = null;
        boolean valid = false;
