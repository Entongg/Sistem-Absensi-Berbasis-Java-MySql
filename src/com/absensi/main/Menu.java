...
public class Menu extends SimpleDrawerBuilder {
    ...
    public SimpleHeaderData getSimpleHeaderData() {
        ...
        if(filePath != null && new File(filePath).exists()){
            ...
            icon = new AvatarIcon(
                getClass().getResource("/com/absensi/img/profile.jpg"),
                50,
                50,
                100f
            );
        ...
        if(loggedInUser == null){
            return new SimpleHeaderData()
                .setIcon(icon)
                .setTitle("Kelompok Cepuluh")
                .setDescription("@kelompok_cepuluh");
        }
    ...
    private void changeAvatarIconBorderColor(AvatarIcon icon) {
        icon.setBorderColor(new AvatarIcon.BorderColor(
