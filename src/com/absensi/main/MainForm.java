...
public class MainForm extends JPanel {
    ...
    private JPanel createFooter(){
        ...
        lbJava.putClientProperty(FlatClientProperties.STYLE, "foreground:$Label.disableForeground");
        lbJava.setIcon(new SVGIconUIColor("raven/modal/demo/icons/java.svg", 1f, "Label.disableForeground"));
        panel.add(lbJava);
    ...
    public void setForm(Form form){
        ...
        buttonUndo.setEnabled(FormManager.FORMS.isRedoAble());
