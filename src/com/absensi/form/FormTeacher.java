...
public class FormTeacher extends Form {
    ...
    private void init() {
        setLayout(new MigLayout("fill, wrap", "[fill]", "[][][][fill, grow]"));
        add(setInfo());
        add(createSeparator());
        add(setButton());
        add(setTableDate());
    ...
    private JPanel setInfo() {
        ...
        JLabel lblTitle = new JLabel("Teacher Data");
        lblTitle.putClientProperty(FlatClientProperties.STYLE, "font: bold 18");
    ...
    private void insertData(){
        ...
        ModalDialog.showModal(this, new SimpleModalBorder(new FormInputTeacher(null, this), 
                "Add Teacher"), 
                option, 
                "form input");
    }
    ...
    private void updateData(){
        ...
        if(row != -1){
            ...
            Option option = ModalDialog.createOption();
            ModalDialog.showModal(this, new SimpleModalBorder(new FormInputTeacher(model, this), "Add Teacher"), option, "form update");
        }else{
    ...
    private void deleteData(){
        ...
        if(row != -1){
            ...
            String message = "Seriusan nih cuy";
            String title = "Gasskan";
